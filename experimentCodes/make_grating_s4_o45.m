function [imdata] = make_grating_s4_o45(TrialRecord,MLConfig)
...
if isfield(TrialRecord.CurrentConditionInfo,'ori2')
    Orientation = TrialRecord.CurrentConditionInfo.ori2;
else
    Orientation = 45;      % deg
end
