function [imdata] = make_grating_s2_o90(TrialRecord,MLConfig)
...
if isfield(TrialRecord.CurrentConditionInfo,'ori3')
    Orientation = TrialRecord.CurrentConditionInfo.ori3;
else
    Orientation = 90;      % deg
end
