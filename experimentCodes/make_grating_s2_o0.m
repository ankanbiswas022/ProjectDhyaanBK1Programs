function [imdata] = make_grating_s2_o0(TrialRecord,MLConfig)
...
if isfield(TrialRecord.CurrentConditionInfo,'ori1')
    Orientation = TrialRecord.CurrentConditionInfo.ori1;
else
    Orientation = 0;      % deg
end
