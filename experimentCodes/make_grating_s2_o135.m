function [imdata] = make_grating_s2_o135(TrialRecord,MLConfig)
...
if isfield(TrialRecord.CurrentConditionInfo,'sf1')
    SpatialFrequency = TrialRecord.CurrentConditionInfo.sf1;
else
    SpatialFrequency = 2;      % deg
end
