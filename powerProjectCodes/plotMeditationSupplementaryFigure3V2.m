...
ylabel(hf0(1,1),{'Stimulus-induced gamma (dB)';'(G1(St-Bl))'},'FontSize',fontSize,'FontWeight','bold');

xlabel(hf0(1,2),{'Meditation-induced gamma (dB)'; '(M2(Bl)-G2(Bl))'},'FontSize',fontSize,'FontWeight','bold');
ylabel(hf0(1,2),{'Stimulus-induced gamma (dB)';'(M2(St-Bl))'},'FontSize',fontSize,'FontWeight','bold');
