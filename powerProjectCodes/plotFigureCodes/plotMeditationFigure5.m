...
if saveFlag
    ...
    print(mainFigure4,fullfile(finalPlotsSaveFolder,'MeditationFigure4'),'-dsvg','-r600');
    print(mainFigure4,fullfile(finalPlotsSaveFolder,'MeditationFigure4'),'-dtiff','-r600');
    print(mainFigure4,fullfile(finalPlotsSaveFolder,'MeditationFigureSupp1'),'-dpdf','-r300');
    print(mainFigure4,fullfile(finalPlotsSaveFolder,'MeditationFigureSupp1u'),'-dpdf','-bestfit','-r300');
end
