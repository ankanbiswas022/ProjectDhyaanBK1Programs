...
gcf = figure('WindowState','maximized','Color',[1 1 1]);
...
% figure captions
annotation(gcf,'textbox',[0.0581  0.9520  0.0738  0.0381],'String','A','LineStyle','none','FontWeight','bold','FontSize',fontSize+4,...
    'FitBoxToText','off');

annotation(gcf,'textbox',[0.4981  0.9520  0.0738  0.0381],'String','B','LineStyle','none','FontWeight','bold','FontSize',fontSize+4,...
    'FitBoxToText','off');

finalPlotsSaveFolder ='D:\Projects\ProjectDhyaan\BK1\ProjectDhyaanBK1Programs\powerProjectCodes\savedFigures';
if saveFlag
%     gcf.Color = [1 1 1];
    savefig(gcf,fullfile(finalPlotsSaveFolder,'MeditationFigure3.fig'));
    print(gcf,fullfile(finalPlotsSaveFolder,'MeditationFigure3'),'-dsvg','-r600');
    print(gcf,fullfile(finalPlotsSaveFolder,'MeditationFigure3'),'-dtiff','-r600');
     print(gcf,fullfile(finalPlotsSaveFolder,'MeditationFigure3'),'-dpdf','-r300');
    print(gcf,fullfile(finalPlotsSaveFolder,'MeditationFigure3'),'-dpdf','-bestfit','-r300');
end