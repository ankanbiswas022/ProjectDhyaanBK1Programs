...
fontSize = 18;
supFigure3 = figure('WindowState','maximized','Color',[1 1 1]);
saveFlag =1;
...
annotation(supFigure3,'textbox',[0.1437  0.8940  0.0738  0.0381],'Color',colorNames(1,:),...
    'String',{'Meditators'},...
    'LineStyle','none',...
    'FontWeight','bold',...
    'FontSize',fontSize);

annotation(supFigure3,'textbox',[0.1438  0.8638  0.0737  0.0381],'Color',colorNames(2,:),...
    'String','Controls',...
    'LineStyle','none',...
    'FontWeight','bold',...
    'FontSize',fontSize);
...
% figure captions
annotation(supFigure3,'textbox',[0.0581  0.9520  0.0738  0.0381],'String','A','LineStyle','none','FontWeight','bold','FontSize',fontSize+4,...
    'FitBoxToText','off');

annotation(supFigure3,'textbox',[0.4981  0.9520  0.0738  0.0381],'String','B','LineStyle','none','FontWeight','bold','FontSize',fontSize+4,...
    'FitBoxToText','off');

% common change across figure!
set(findobj(supFigure3,'type','axes'),'box','off'...
    ,'FontWeight','Bold'...
    ,'TickDir','out'...
...
if saveFlag
    supFigure3.Color = [1 1 1];
    savefig(supFigure3,fullfile(finalPlotsSaveFolder,'MeditationFigureSupp3.fig'));
    print(supFigure3,fullfile(finalPlotsSaveFolder,'MeditationFigureSupp3'),'-dsvg','-r300');
    print(supFigure3,fullfile(finalPlotsSaveFolder,'MeditationFigureSupp3'),'-dtiff','-r300');
     print(supFigure3,fullfile(finalPlotsSaveFolder,'MeditationFigureSupp3'),'-dpdf','-r300');
    print(supFigure3,fullfile(finalPlotsSaveFolder,'MeditationFigureSupp3u'),'-dpdf','-bestfit','-r300');
end