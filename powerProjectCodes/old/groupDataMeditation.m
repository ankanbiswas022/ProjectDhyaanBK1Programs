...
loadFolderpath = getFolderName(biPolarFlag,removeIndividualUniqueBadTrials,removeDeclaredBadElecs);
% load(loadFilepath);
...
subjectNameGrouped = getPairedSubjectsBK1;

problamaticIndices = find(ismember(subjectNameGrouped,{'053DR'}));
subjectNameGrouped(problamaticIndices,:) = [];
...
loadFilepath = fullfile(sdParams.folderSourceString,'data','savedData',saveFolderName);
end
