function plotMeditationFigure2Associated(subjectNameLists0,montageChanlocs, badEyeCondition,badTrialVersion, analysisChoice, badElectrodeRejectionFlag,cutOffList,useMedianFlag,significanceFlag,hTopoSlope,hBarSlope,colorNames)
