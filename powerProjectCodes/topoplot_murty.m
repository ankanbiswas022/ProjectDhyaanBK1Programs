...
%%%%%%%%%%%%%%%% example use %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%'
% topoplot_murty(data,montageChanlocs,'electrodes','on','maplimits',cLimsTopo,'plotrad',0.6,'headrad',0.6,'emarkercolors',data,'style','both'); colorbar;
% topoplot_murty(data,montageChanlocs,'electrodes','on','style','blank','drawaxis','off','nosedir','+X','emarkercolors',data,'plotrad',0.63,'headrad',0.6); colorbar;
% topoplot_murty(data,montageChanlocs,'electrodes','on','style','blank','drawaxis','off','nosedir','+X','emarkercolors',data,'plotchans',[1 64],'plotrad',0.65,'headrad',0.6,'emarker',{'.','k',12,1});
