% This program displays the connectivity data

function [slope_all,pvals,subjectNameListTMPaccum] = displayConnData(folderSourceString,figR,figpath,subjectNameLists,methodOptions,strList,projectName,refType,protocolType,stRange,freqRanges,freqRangeNames,removeMicroSaccadesFlag,useMedianFlagBarPlot,spatialFrequenciesToRemove,useCleanData,useMedianFlagData,subjectNameListTMPstored)
